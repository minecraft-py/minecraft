...
from minecraft.gui.widgets import TextButton, Label
...
class StartScene(Scene):
    ...
    def __init__(self):
        ...
        self.title_minec = Sprite(self.window.assets.loader.image(
            "textures/gui/title/minecraft.png").get_region(*REGION["title_minec"]))
        ...
        self.title_raft = Sprite(self.window.assets.loader.image(
            "textures/gui/title/minecraft.png").get_region(*REGION["title_raft"]))
        ...
        self.label_version = Label(f"Minecraft.py {VERSION['str']}",
                                   x=width, y=0, anchor_x="right", anchor_y="bottom")
        self.button_sglp = TextButton(self.window.assets.translate("menu.singleplayer"),
                                      width // 2 - 100, height // 2 - 20, 200, 40)
        self.frame.add_widget(self.button_sglp)
    ...
    def on_resize(self, width, height):
        ...
        with self.frame.update():
            self.button_sglp.position = (width // 2 - 100, height // 2 - 20)
